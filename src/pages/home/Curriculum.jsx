...
function Curriculum(props) {
    const courses = [{ heading: "Python", duration: "Duration : 35 hr 10 min", projects: "Projects : 7" },
    { heading: "Data Structure & Algorithm", duration: "Duration : 35 hr 10 min", projects: "Projects : 7" },
    { heading: " DBMS with SQL", duration: "Duration : 35 hr 10 min", projects: "Projects : 7" },
    { heading: "Devops", duration: "Duration : 35 hr 10 min", projects: "Projects : 7" },
    { heading: "Machine Learning", duration: "Duration : 35 hr 10 min", projects: "Projects : 7" }
    ]
                ...
                <div className="curriculum-middle">
                    <div className="curriculum-middle-card1">
                        <p className="curriculum-card-para f-22">
                            ...
                            <span>Industry Standard Courses</span>
                        </p>
                    </div>
